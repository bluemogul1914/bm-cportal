...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$client_name || !$product_line) {
        ...
        header("Location: /portal/dealer-orders.php?success=" . urlencode("Order <strong>$order_ref</strong> submitted! Your commission of <strong>\$$" . dollars($spiff_cents) . "</strong> will be approved on confirmed activation."));
        exit;
    }
}
