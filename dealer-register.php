...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$full_name || !$email) {
        ...
        try {
            ...
            $check->execute([$email]);
            if ($check->fetch()) {
                $error = 'That email address is already registered. <a href="/portal/index.php" style="color:var(--blue);">Sign in here</a>.';
            } else {
...
<div class="top-bar">
  ...
  <a href="/portal/index.php" class="top-link">Already registered? Sign in →</a>
</div>
