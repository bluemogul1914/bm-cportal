<div class="w-64 bg-secondary text-white flex-shrink-0 flex flex-col">
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4">
        ...
        <div class="space-y-1">
            ...
            <a href="frontier-qualify.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo ($current_page == 'frontier-qualify.php') ? 'bg-blue-600 text-white font-medium' : 'text-gray-300 hover:bg-gray-700 hover:text-white transition'; ?>">
                <i class="fas fa-wifi w-5"></i>
                <span>Fiber Pre-Qual</span>
            </a>
